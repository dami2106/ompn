...
class CompILE(nn.Module):
    ...
    def __init__(self, vec_size, hidden_size, action_size,
                 env_arch, max_num_segments, latent_dist='gaussian',
        ...
        self.env_emb = get_env_encoder(env_arch, 1)
    ...
    def forward(self, batch, lengths):
        ...
        # accuracy
        return result, {'segment': all_b['samples'], 'all_b': all_b, 'all_z': all_z,
                        'all_recs': all_recs, 'all_encs': all_encs, 'all_masks': all_masks}
